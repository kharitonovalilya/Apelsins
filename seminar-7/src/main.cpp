...
int main() {
    ...
    //playlist.addMedia(new AudioTrack("Blinding Lights", "The Weeknd", 200, 48000));
    ...
    playlist.addMedia(new PodcastEpisode("The Art of Code", "Jane Doe", 42, 2700));
    playlist.addMedia(new PodcastEpisode("Design Patterns", "John Smith", 15, 1850));
